...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="dzielnik_100kHz_na_400Hz" name="dzielnik_100kHz_na400Hz_inst">
            <blockpin signalname="clk" name="clk" />
            <blockpin signalname="XLXN_3" name="wy" />
        </block>
        <block symbolname="licznik_cyfra" name="licznik_cyfra_inst">
            <blockpin signalname="XLXN_3" name="clk" />
            <blockpin signalname="XLXN_61(1:0)" name="wy(1:0)" />
        </block>
        <block symbolname="aktywna_anoda" name="aktywna_anoda_inst">
            <blockpin signalname="XLXN_61(1:0)" name="we(1:0)" />
            <blockpin signalname="wy_aktywna_anoda(3:0)" name="wy(3:0)" />
        </block>
        <block symbolname="moj_projekt" name="moj_projekt1_inst">
        ...
        <block symbolname="mult_vec1" name="mult_vec11_inst">
            <blockpin signalname="XLXN_61(1:0)" name="we(1:0)" />
        ...
        <block symbolname="dzielnik_400Hz_na_10Hz" name="dzielnik_400Hz_na_10Hz_inst">
            <blockpin signalname="XLXN_3" name="clk" />
            <blockpin signalname="XLXN_32" name="wy" />
        </block>
        <block symbolname="moj_projekt" name="moj_projekt2_inst">
            <blockpin signalname="XLXN_32" name="clk" />
        ...
        <block symbolname="moj_projekt_Diody" name="moj_projekt_Diody_inst">
            <blockpin signalname="sw0" name="sw0" />
        ...
        <block symbolname="ster_kropka" name="ster_kropka_inst">
            <blockpin signalname="XLXN_61(1:0)" name="we(1:0)" />
            <blockpin signalname="wy_sterowanie_kropka" name="wy" />
        </block>
        <block symbolname="transkoder_7s" name="transkoder_7s_inst">
            <blockpin signalname="XLXN_60(3:0)" name="we(3:0)" />
            <blockpin signalname="wy_transkoder_7s(6:0)" name="wy(6:0)" />
        </block>
        <block symbolname="mult_vec1" name="mult_vec12_inst">
            <blockpin signalname="XLXN_61(1:0)" name="we(1:0)" />
        ...
        <block symbolname="moj_projekt_MUX" name="moj_projekt_MUX_inst">
            <blockpin signalname="sw0" name="sw0" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        <instance x="480" y="688" name="dzielnik_100kHz_na400Hz_inst" orien="R0">
        </instance>
        <branch name="clk">
            <wire x2="480" y1="656" y2="656" x1="368" />
        </branch>
        <iomarker fontsize="28" x="368" y="656" name="clk" orien="R180" />
        <instance x="1104" y="688" name="licznik_cyfra_inst" orien="R0">
        </instance>
        <instance x="1680" y="672" name="aktywna_anoda_inst" orien="R0">
        </instance>
        <instance x="192" y="992" name="dzielnik_400Hz_na_10Hz_inst" orien="R0">
        </instance>
        <branch name="XLXN_3">
        ...
        <instance x="2208" y="1520" name="ster_kropka_inst" orien="R0">
        </instance>
        ...
        <instance x="2128" y="1216" name="mult_vec11_inst" orien="R0">
        </instance>
        <branch name="sw0">
        ...
        <instance x="1920" y="1904" name="mult_vec12_inst" orien="R0">
        </instance>
        <instance x="2656" y="1376" name="moj_projekt_MUX_inst" orien="R0">
        </instance>
        <iomarker fontsize="28" x="3392" y="1040" name="wy_transkoder_7s(6:0)" orien="R0" />
        <instance x="2912" y="1072" name="transkoder_7s_inst" orien="R0">
        </instance>
        ...
        <instance x="1264" y="1872" name="moj_projekt2_inst" orien="R0">
        </instance>
    </sheet>
</drawing>